...
extern "C"
{
	...
	{ 
		...
		consumerClass.method<&MConsumer::setInstanceName>("setInstanceName", {
				Php::ByVal("groupName", Php::Type::String),
				});
		consumerClass.method<&MConsumer::setNamesrvDomain>("setNamesrvDomain", {
				Php::ByVal("nameserver", Php::Type::String),
				});
		consumerClass.method<&MConsumer::setTopic>("setTopic", {
				Php::ByVal("topic", Php::Type::String),
				});
